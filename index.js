...
/**
 * This action is currently a fork of Serverless CodeDeployLambda, potentially
 * extended with some other fixes to Serverless
 */
...
module.exports   = function(S) {
  ...
  class ServerlessAWSOverrides extends S.classes.Plugin {
    ...
    registerActions() {
      ...
      // Override the code deploy lambda
